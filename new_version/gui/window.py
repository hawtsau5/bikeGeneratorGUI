...
class Windows:
    ...
    def draw_window(self):
        ...
        self.__separator_window()

    def __separator_window(self):
        bimpy.set_next_window_pos(bimpy.Vec2(5, 235), bimpy.Condition.Once)
        bimpy.set_next_window_size(bimpy.Vec2(1005, 0), bimpy.Condition.Once)
        bimpy.set_next_window_focus()

        bimpy.begin("Separator", flags=bimpy.WindowFlags(4) | bimpy.WindowFlags(1) | bimpy.WindowFlags(2))
        bimpy.separator()
        bimpy.text("")
        bimpy.separator()
        bimpy.end()
    ...
    def __distance_window(self):
        bimpy.set_next_window_pos(bimpy.Vec2(5, 120), bimpy.Condition.Once)
        bimpy.set_next_window_size(bimpy.Vec2(345, 110), bimpy.Condition.Once)
        bimpy.set_next_window_focus()
    ...
    def __calories_burtn_window(self):
        bimpy.set_next_window_pos(bimpy.Vec2(355, 5), bimpy.Condition.Once)
        bimpy.set_next_window_size(bimpy.Vec2(345, 110), bimpy.Condition.Once)
        bimpy.set_next_window_focus()
    ...
    def __speed_window(self):
        bimpy.set_next_window_pos(bimpy.Vec2(355, 120), bimpy.Condition.Once)
        bimpy.set_next_window_size(bimpy.Vec2(345, 110), bimpy.Condition.Once)
        bimpy.set_next_window_focus()
    ...
    def __heart_rate_window(self):
        bimpy.set_next_window_pos(bimpy.Vec2(705, 5), bimpy.Condition.Once)
